...
common_opts="--gpu ${GPU} --epochs 125 --disable-progress-bar --seed 1234"
#common_opts="--gpu ${GPU} --epochs 50 --seed 1234"

for tr in TrainSetA; do
  mkdir -p $tr
  poetry run mxfold2 train ${common_opts} --log-dir $tr --save-config $tr-mod.conf --resume epoch-100 --param $tr-mod.pth  \
